...
def get_client():
    return tweepy.Client(bearer_token, consumer_key, consumer_secret, access_token, access_token_secret, wait_on_rate_limit=True)
...
def fetch_latest_tweet(client):
    ...
    latestResponse = perform_tweepy_operation(client.get_home_timeline, **response_params)
